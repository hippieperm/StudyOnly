			...
			<form action="edit_f.jsp" method="post" onsubmit="return cunf()">
				...
				%>
					<tr>
						<td>회원번호</td>
						<td>
							<input type="text" name="custno" id="custno" value="<%=rs.getInt("custno")%>">
						</td>
						</tr>
						<tr>
						<td>회원성명</td>
						<td>
							<input type="text" name="custname" id="custname" value="<%=rs.getString("custname")%>">
						</td>
						<tr>
						<td>회원전화번호</td>
						<td>
						...
						<td>가입일자</td>
						<td>
							<input type="text" name="joindate" id="joindate" value="<%=rs.getDate("joindate")%>">
						</td>
						</tr>
						<tr>
						<td>고객등급[A:VIP, B:일반 C:직원]</td>
						<td>
							<input type="text" name="grade" id=grade value="<%=rs.getString("grade")%>">
						</td>
						</tr>
						<tr>
						<td>도시코드</td>
